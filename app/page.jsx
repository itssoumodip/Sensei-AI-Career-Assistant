    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter text-center mb-12">Advanced Tools to Accelerate Your Career Growth</h2>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-muted-foreground">Interview Quesitons</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
      ...
      <section className="w-full">
        <div className="mx-auto py-24 rounded-lg bg-gradient-to-b from-gray-400 via-gray-200 to-gray-600">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <p className="mx-auto max-w-[800px] text-primary-foreground/80 md:text-xl">
              Join thousands of professionals who have transformed their careers with Sensei. 
              <br />
